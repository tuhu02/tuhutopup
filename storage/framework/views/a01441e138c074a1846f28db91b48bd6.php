                ...
                <?php $__empty_1 = true; $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-stretch">
                        <div class="berita-card">
                            <img src="<?php echo e($b->path); ?>" class="berita-card-img" alt="<?php echo e($b->judul ?? 'Gambar Berita'); ?>">
                            <div class="berita-card-body">
                                <h5 class="berita-card-title"><?php echo e($b->judul ?? 'Judul Berita'); ?></h5>
                                <p class="berita-card-text"><?php echo e(Str::limit(strip_tags($b->deskripsi ?? ''), 120)); ?></p>
                                <div class="berita-meta">
                                    <div class="berita-date">
                                        <i class="fas fa-calendar-alt"></i>
                                        <span><?php echo e($b->created_at ? $b->created_at->format('d M Y') : 'Tanggal tidak tersedia'); ?></span>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bismillah sukses\SourceCode-topupaja-v1\topupaja\resources\views/template/berita.blade.php ENDPATH**/ ?>