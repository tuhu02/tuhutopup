            ...
            <div class="col-lg-4">
                <div class="card bg-card border-0 mb-4 shadow-form">
                    ...
                    <div class="col-12 px-3 pb-2">
                        <img src="<?php echo e($kategori->thumbnail); ?>" alt="" width="100" class="float-start mr-2"
                            style="border-radius: 16px; margin-top: -50px;">
                        <div class="col-8 mt-2 mt-lg-0 float-end">
                            <h4 class="text-black"><?php echo e($kategori->nama); ?></h4>
                        </div>
                    </div>
                    <div class="col px-3 mb-4">
                        <small style="font-size: 14px;" class="text-black"><?php echo $kategori->deskripsi_game; ?></small>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <form class="my-form" id="form-order" name="my-form">
                    ...
                    <input type="hidden" id="ktg_tipe"
                        value="<?php echo e($kategori->tipe); ?>">

                        <div class="card bg-card border-0 mb-4 shadow-form">
                            <div class="px-3 py-3">
                                <div class="d-flex border-bottom w-full num-page">
                                    <div class="text-black">1</div>
                                    <p class="d-flex text-black">Informasi Pesanan</p>
                                </div>
                                <div class="row text-black">
                                    <?php if($kategori->server_id && $kategori->kode != "life-after" && $kategori->kode != "genshin-impact" && $kategori->kode != "ragnarok-m" && $kategori->kode != "tof"): ?>
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" placeholder="Masukkan User ID" id="user_id"
                                                name="user_id" autocomplete="off">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" placeholder="Masukkan Server ID" name="zone_id"
                                                id="zone" autocomplete="off">
                                        </div>
                                    ...
                                    <?php elseif($kategori->kode == "tof"): ?>
                                        ...
                                        <div class="col-6">
                                            <select class="form-control" id="zone">
                                                ...
                                                <option value="North America-The Worlds Between">North America-The Worlds Between
                                                </option>
                                                ...
                                                <option value="North America-Eternium Phantasy">North America-Eternium Phantasy
                                                </option>
                                    ...
                                    <?php elseif($kategori->kode == "mobile-legends"): ?>
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" placeholder="Masukkan Zone ID" name="zone_id"
                                                id="zone" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "apex-legends-mobile"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Player ID" id="user_id"
                                                name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "call-of-duty-mobile"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Open ID" id="user_id"
                                                name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "point-blank"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan User ID / ID Login"
                                    ...
                                    <?php elseif($kategori->kode == "valorant"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Riot ID" id="user_id"
                                                name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "tri"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Tri Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "telkomsel"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Telkomsel Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "indosat"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Indosat Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "smartfren"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Smartfren Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "xl"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor XL Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "axis"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Axis Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "gopay"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Gopay Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "ovo"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor OVO Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "isaku"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor i.saku Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "shopeepay"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor ShopeePay Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "dana"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor Dana Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    <?php elseif($kategori->kode == "linkaja"): ?>
                                        <div class="col-12">
                                            <input type="text" class="form-control" placeholder="Masukkan Nomor LinkAja Anda"
                                                id="user_id" name="user_id" autocomplete="off">
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if($kategori->brand === 'JASA JOKI'): ?>


                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <input type="text" class="form-control" placeholder="Masukkan Email" id="email_joki"
                                                        name="email_joki" autocomplete="off">
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <input type="password" class="form-control" placeholder="Masukkan Password"
                                                        id="password_joki" name="password_joki" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-2">
                                                    <input type="text" class="form-control" placeholder="Masukkan Nickname"
                                                        id="nickname_joki" name="nickname_joki" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <input type="text" class="form-control"
                                                        placeholder="Min Request 3 Hero (Diusahakan)" id="request_joki"
                                                        name="request_joki" autocomplete="off">
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <input type="text" class="form-control" placeholder="Catatan untuk Penjoki"
                                                        id="catatan_joki" name="catatan_joki" autocomplete="off">
                                                </div>
                                            </div>
                        ...
                        <div class="card bg-card border-0 mb-4 shadow-form">
                            <div class="px-3 py-3">
                                <div class="num-page border-bottom text-black">
                                ...
                                <div class="row mt-4">
                                    <?php if($kategori->kode === 'mobile-legends'): ?>
                                        <?php
                                            $weeklyItems = $nominal->filter(function ($n) {
                                                $name = \Illuminate\Support\Str::lower($n->layanan);
                                                return \Illuminate\Support\Str::contains($name, ['weekly', 'week', 'minggu', 'wdp']);
                                            });
                                            $diamondItems = $nominal->reject(function ($n) {
                                                $name = Illuminate\Support\Str::lower($n->layanan);
                                                return Illuminate\Support\Str::contains($name, ['weekly', 'week', 'minggu', 'wdp']);
                                            });
                                        ?>

                                        <?php if($weeklyItems->count()): ?>
                                            <div class="col-12">
                                                <h6 class="text-black mb-2">Weekly</h6>
                                            </div>
                                            <?php $__currentLoopData = $weeklyItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-6 col-md-3 col-lg-4 mb-3">
                                                    <div id="product-<?php echo e($nom->id); ?>"
                                                        class="p-2 px-3 cursor-pointer bg-product product-list position-relative text-black"
                                                        product-id="<?php echo e($nom->id); ?>" onclick="selectProduct(<?php echo e($nom->id); ?>)">
                                                        <b class="d-block"><?php echo e($nom->layanan); ?></b>
                                                        <span class="harga text-black">Rp <?php echo e(number_format($nom->harga)); ?>,-</span>
                                                        <img src="https://sin1.contabostorage.com/b1d79b8bbee7475eab6c15cd3d13cd4d:knock/p/1731418357.webp"
                                                            alt="Weekly" class="productlogo">
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>

                                        <?php if($diamondItems->count()): ?>
                                            <div class="col-12 mt-2">
                                                <h6 class="text-black mb-2">Diamond</h6>
                                            </div>
                                            <?php $__currentLoopData = $diamondItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-6 col-md-3 col-lg-4 mb-3">
                                                    <div id="product-<?php echo e($nom->id); ?>"
                                                        class="p-2 px-3 cursor-pointer bg-product product-list position-relative text-black"
                                                        product-id="<?php echo e($nom->id); ?>" onclick="selectProduct(<?php echo e($nom->id); ?>)">
                                                        <b class="d-block"><?php echo e($nom->layanan); ?></b>
                                                        <span class="harga text-black">Rp <?php echo e(number_format($nom->harga)); ?>,-</span>
                                                        <img src="https://sin1.contabostorage.com/b1d79b8bbee7475eab6c15cd3d13cd4d:knock/p/17066126930981670143.webp"
                                                            alt="Diamond" class="productlogo">
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                            ...
                            <div class="px-3 py-3">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <div class="accordion mb-3" id="accordionExample-1"
                                            style="box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1),0 2px 4px -1px rgba(0, 0, 0, 0.06);border-radius: 6px;">
                                            <div class="accordion-item border-0">
                                                <h2 class="accordion-header" id="heading-balance">
                                                    <button class="accordion-button collapsed bg-white-custom text-white"
                                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapse-balance"
                                                        aria-expanded="false" aria-controls="collapse-balance">
                                                        <div class="accordion-tipe">Saldo Akun</div>
                                                    </button>
                                                </h2>
                                                <div id="collapse-balance" class="accordion-collapse collapse"
                                                    aria-labelledby="heading-balance" data-bs-parent="#accordionExample-balance">
                                                    <div class="accordion-body bg-payment">
                                                        <div class="row">
                                                            <div class="col-6 col-md-3 col-lg-4">
                                                                <div id="method-balance"
                                                                    class="p-2 border rounded mb-3 method-list bg-light shadow-sm"
                                                                    method-id="SALDO">
                                                                    <table class="w-100 border-bottom mb-2">
                                                                        <tr>
                                                                            <td>
                                                                                <img src="https://is3.cloudhost.id/nextopupcdn/p/wallet.gif" alt=""
                                                                                    class="w-75">
                                                                            </td>
                                                                            <td>
                                                                                <b style="font-size: 12px;white-space: nowrap;"
                                                                                    method-price="balance" id="SALDO"></b>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <div style="font-size: 12px;color: #718096;">
                                                                        <b class="d-block mb-2">Saldo Akun akan terpotong secara otomatis</b>
                                            ...
                                            <div class="bg-payment p-2 text-end border-0 text-nowrap"
                                                style="border-radius: 0 0 6px 6px;overflow-x: auto">
                                    ...
                                    <div class="accordion mb-3" id="accordionExample-1"
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="heading-qris">
                                                <button class="accordion-button collapsed bg-white-custom text-white"
                                                    type="button" data-bs-toggle="collapse" data-bs-target="#collapse-qris"
                                                    aria-expanded="false" aria-controls="collapse-ewallet">
                                                    <div class="accordion-tipe">QRIS</div>
                                                </button>
                                            </h2>
                                            <div id="collapse-qris" class="accordion-collapse collapse"
                                                aria-labelledby="heading-qris" data-bs-parent="#accordionExample-1">
                                                <div class="accordion-body bg-payment">
                                                    <div class="row">
                                    ...
                                    <div class="accordion mb-3" id="accordionExample-1"
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="heading-ewallet">
                                                <button class="accordion-button collapsed bg-white-custom text-white"
                                                    type="button" data-bs-toggle="collapse" data-bs-target="#collapse-ewallet"
                                                    aria-expanded="false" aria-controls="collapse-ewallet">
                                                    <div class="accordion-tipe">E-Wallet</div>
                                                </button>
                                            </h2>
                                            <div id="collapse-ewallet" class="accordion-collapse collapse"
                                                aria-labelledby="heading-ewallet" data-bs-parent="#accordionExample-1">
                                                <div class="accordion-body bg-payment">
                                                    <div class="row">
                                                        <?php $__currentLoopData = $pay_method; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="heading-convenience-store">
                                                <button class="accordion-button collapsed bg-white-custom text-white"
                                                    ...
                                                    data-bs-target="#collapse-convenience-store" aria-expanded="false"
                                                    aria-controls="collapse-convenience-store">
                                                    <div class="accordion-tipe">Convenience Store</div>
                                                </button>
                                            </h2>
                                            <div id="collapse-convenience-store" class="accordion-collapse collapse"
                                                aria-labelledby="heading-convenience-store"
                                    ...
                                    <div class="accordion mb-3" id="accordionExample-1" disabled
                                        style="box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1),0 2px 4px -1px rgba(0, 0, 0, 0.06);border-radius: 6px;">
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="heading-virtual-account">
                                                <button class="accordion-button collapsed bg-white-custom text-white"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse-virtual-account" aria-expanded="false"
                                                    aria-controls="collapse-virtual-account">
                                                    <div class="accordion-tipe">Virtual Account</div>
                                                </button>
                                            </h2>
                                            <div id="collapse-virtual-account" class="accordion-collapse collapse"
                                                aria-labelledby="heading-virtual-account" data-bs-parent="#accordionExample-5">
                                                <div class="accordion-body bg-payment">
                                                    <div class="row">
                                                        <?php $__currentLoopData = $pay_method; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card bg-card border-0 shadow-form">
                            <div class="px-3 pt-3" style="margin-bottom: 15px;">
                                <div class="num-page border-bottom">
                                    ...
                                    <p class="text-black">No Whatsapp</p>
                                </div>
                                <div class="mt-3">
                                    <input type="number" class="form-control" placeholder="08xXXXXXXX" id="nomor"
                                        autocomplete="off" name="whatsapp">
                                    <p class="mt-3 text-black" style="font-size: 13px;">Bukti pembayaran atas pembelian anda
                                        akan kami kirimkan ke WhatsApp anda.</p>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bismillah sukses\SourceCode-topupaja-v1\topupaja\resources\views/template/order.blade.php ENDPATH**/ ?>