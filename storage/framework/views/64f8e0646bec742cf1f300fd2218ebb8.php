                            ...
                            <div class="row mb-4">
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="info-card text-center">
                                        ...
                                        <p class="balance-amount mb-0"><?php echo e($totalOrders); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="info-card text-center">
                                        ...
                                        <p class="balance-amount mb-0"><?php echo e($successOrders); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="info-card text-center">
                                        ...
                                        <p class="balance-amount mb-0"><?php echo e($pendingOrders); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 mb-3">
                                    <div class="info-card text-center">
                                        ...
                                        <p class="balance-amount mb-0"><?php echo e($failedOrders); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    <div class="info-card">
                                        ...
                                        <p class="balance-amount mb-0">Rp <?php echo e(number_format($user->balance, 0, ',', '.')); ?>,-
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="info-card">
                                        ...
                                        <p class="balance-amount mb-0">Rp <?php echo e(number_format($totalSpent, 0, ',', '.')); ?>,-
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="order-card d-flex justify-content-between align-items-center">
                                            <div class="order-details">
                                                <span class="badge bg-warning text-dark order-id"><?php echo e($order->order_id); ?></span>
                                                <p class="mb-1"><?php echo e($order->layanan); ?></p>
                                                <small class="text-muted">
                                                    <i class="fas fa-user me-1"></i><?php echo e($order->nickname); ?>

                                                    <?php if($order->zone): ?>
                                                        <span class="ms-2"><i class="fas fa-server me-1"></i><?php echo e($order->zone); ?></span>
                                                    <?php endif; ?>
                                                </small>
                                                <div class="mt-1">
                                                    <small class="text-muted">Rp
                                                        <?php echo e(number_format($order->harga, 0, ',', '.')); ?>,-</small>
                                                    <small
                                                        class="text-muted ms-2"><?php echo e($order->created_at->format('d M Y H:i')); ?></small>
                                                </div>
                                            </div>
                                            <div class="text-end">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="profile-info-item">
                                            ...
                                            <p class="mb-2"><?php echo e($user->name); ?></p>
                                        </div>
                                        <div class="profile-info-item">
                                            <label class="text-muted small">Username</label>
                                            <p class="mb-2"><?php echo e($user->username); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="profile-info-item">
                                            ...
                                            <p class="mb-2">
                                                <span class="badge-gold-member"><?php echo e(ucfirst($user->role)); ?></span>
                                            </p>
                                        </div>
                                        <div class="profile-info-item">
                                            <label class="text-muted small">No. WhatsApp</label>
                                            <p class="mb-2"><?php echo e($user->no_wa ?? 'Belum diisi'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3">
