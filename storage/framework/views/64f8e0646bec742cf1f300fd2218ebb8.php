                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                <div class="info-card">
                                    ...
                                    <p class="balance-amount mb-0">Rp <?php echo e(number_format($user->balance, 0, ',', '.')); ?>,-</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="info-card">
                                    <h5><i class="fas fa-money-bill-wave me-2"></i>Total Pengeluaran</h5>
                                    <p class="balance-amount mb-0">Rp <?php echo e(number_format($totalSpent, 0, ',', '.')); ?>,-</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="order-card d-flex justify-content-between align-items-center">
                                        <div class="order-details">
                                            ...
                                            <div class="mt-1">
                                                <small class="text-muted">Rp <?php echo e(number_format($order->harga, 0, ',', '.')); ?>,-</small>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel">
                    <div class="content-section">
                        <div class="info-card">
                            ...
                            <div class="mt-3">
                                <a href="<?php echo e(url('/user/edit/profile')); ?>" class="btn btn-primary">
