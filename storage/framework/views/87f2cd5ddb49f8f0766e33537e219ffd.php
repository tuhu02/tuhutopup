            ...
            <div class="form-section">
                ...
                <form action="<?php echo e(url('/user/edit/profile')); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" autocomplete="off" 
                                       value="<?php echo e(Auth()->user()->username); ?>" name="username" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="no_wa" 
                                       autocomplete="off" value="<?php echo e(Auth()->user()->no_wa); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo e(url('/user/dashboard')); ?>" class="btn btn-secondary">
