            ...
            <div class="col-lg-4">
                <div class="card bg-card border-0 mb-4 shadow-form">
                    ...
                    <div class="col-12 px-3 pb-2">
                        <img src="{{ $kategori->thumbnail  }}" alt="" width="100" class="float-start mr-2"
                            style="border-radius: 16px; margin-top: -50px;">
                        <div class="col-8 mt-2 mt-lg-0 float-end">
                            <h4 class="text-black">{{$kategori->nama}}</h4>
                        </div>
                    </div>
                    <div class="col px-3 mb-4">
                        <small style="font-size: 14px;" class="text-black">{!! $kategori->deskripsi_game !!}</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                            ...
                            <div class="px-3 py-3">
                                ...
                                <div class="row mt-4">
                                    @if($kategori->kode === 'mobile-legends')
                                        ...
                                        @if($weeklyItems->count())
                                            <div class="col-12">
                                                <h6 class="text-black mb-2">Weekly</h6>
                                            </div>
                                            @foreach($weeklyItems as $nom)
                                                <div class="col-6 col-md-3 col-lg-4 mb-3">
                                                    <div id="product-{{$nom->id}}"
                                                        ...
                                                        <span class="harga text-black">Rp {{ number_format($nom->harga) }},-</span>
                                        ...
                                        @if($diamondItems->count())
                                            <div class="col-12 mt-2">
                                                <h6 class="text-black mb-2">Diamond</h6>
                                            </div>
                                            @foreach($diamondItems as $nom)
                                                <div class="col-6 col-md-3 col-lg-4 mb-3">
                                                    <div id="product-{{$nom->id}}"
                                                        class="p-2 px-3 cursor-pointer bg-product product-list position-relative text-black"
                                                        product-id="{{$nom->id}}" onclick="selectProduct({{$nom->id}})">
