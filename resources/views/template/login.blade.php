            ...
            <div class="login-wrapper">
                ...
                <form action="{{url('/login')}}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{url('/forgot-password')}}" class="text-decoration-none text-warning">Lupa kata sandi?</a>
                    </div>
                ...
                <div class="login-footer text-center text-muted">
                    Belum memiliki akun?
                    <a href="{{url('/register')}}" class="text-decoration-none text-warning">Daftar Sekarang</a>
                </div>
            </div>
        </div>
        
        {{-- Kolom Kanan untuk Banner/Gambar --}}
        {{-- DIUBAH: Hapus div wrapper dan tambahkan class p-0 & login-banner-img --}}
