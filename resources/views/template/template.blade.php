...
<body>
    <div class="content">
        ...
        <div class="content-body">
            {{-- KONTEN UTAMA ANDA MUNCUL DI SINI DARI @yield('content') --}}
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-lg-4 p-4">
                    <img src="{{url('')}}{{ !$config ? '' : $config->logo_footer }}" alt="LOGO" class="logo-bawah"
                        width="50">
                    <div class="mt-2 text-justify">
                        <p>Top Up Game Favoritmu termurah hanya di {{ ENV('APP_NAME') }}, seperti Top Up Mobile Legends,
                    ...
                    <div class="mt-3">
                        @if(Auth::check())
                            @if(Auth()->user()->role == 'Member' || Auth()->user()->role == 'Platinum' || Auth()->user()->role == 'Gold')
                                ...
                                <a href="{{url('/cari')}}">Cek Pesanan</a><br>
                                <a href="{{url('/daftar-harga')}}">Daftar Harga</a><br>
                                <a href="{{url('/riwayat-pembelian')}}">Riwayat Pembelian</a><br>
                                <a href="{{url('/deposit')}}">Top Up Saldo</a><br>
                                <a href="{{url('/user/edit/profile')}}">Edit Profile</a><br>
                                <a href="{{url('/membership')}}">Upgrade Membership</a><br>
                            @else
                                <a href="{{url('')}}">Home</a><br>
                                <a href="{{url('/cari')}}">Cek Pesanan</a><br>
                                <a href="{{url('/daftar-harga')}}">Daftar Harga</a><br>
                ...
                <div class="col-md-3 col-lg-2 p-4">
                    ...
                    <div class="mt-3">
                        <i class="fab fa-whatsapp"></i> <a href="{{ !$config ? '' : $config->url_wa }}"
                            target="_blank">WhatsApp</a><br>
                        <i class="fab fa-instagram"></i> <a href="{{ !$config ? '' : $config->url_ig }}"
                            target="_blank">Instagram</a><br>
                        <i class="fab fa-facebook"></i> <a href="{{ !$config ? '' : $config->url_fb }}"
