...
{{-- Salin dan tempel bagian @section('content') Anda yang sudah ada di sini --}}
@section('content')
...
<div class="container-fluid g-0 register-container">
    <div class="row g-0 w-100">
        ...
        {{-- Kolom Kiri untuk Form register --}}
        <div class="col-lg-5 d-flex align-items-center justify-content-center" style="background-color: #ffffffff;">
            <div class="register-wrapper">
                ...
                <form action="{{url('/register')}}" method="POST" class="my-forma">
                    @csrf
                     <div class="mb-3">
                    ...
                    <p class="mt-3">Sudah memiliki akun ? <a href="{{url('/login')}}" class="text-decoration-none text-primary">Masuk</a></p>
                </form>
            </div>
        </div>
