...
use App\Http\Controllers\LayananPpobController;
...
Route::get('/berita', [App\Http\Controllers\indexController::class, 'berita'])->name('berita');
Route::get('/berita/search', [App\Http\Controllers\indexController::class, 'searchBerita'])->name('berita.search');
...
Route::get('/debug/users', [ForgotPasswordController::class, 'debugUsers']);
Route::get('/debug/phone-search', [ForgotPasswordController::class, 'testPhoneSearch']);

// WhatsApp Configuration routes (Admin only)
Route::get('/whatsapp-config', [ForgotPasswordController::class, 'showWhatsAppConfig'])->middleware('auth');
Route::post('/whatsapp-config', [ForgotPasswordController::class, 'updateWhatsAppConfig'])->middleware('auth');
Route::post('/whatsapp-config/test', [ForgotPasswordController::class, 'testWhatsAppConfig'])->middleware('auth');

// WhatsApp Debug routes (Admin only)
Route::get('/whatsapp-debug', [ForgotPasswordController::class, 'debugWhatsAppApi'])->middleware('auth');
Route::post('/whatsapp-debug/test-detail', [ForgotPasswordController::class, 'testWhatsAppApiDetail'])->middleware('auth');
...
Route::middleware(['auth', 'check.role'])->group(function () {
    ...
    //Berita
    Route::get('/admin/berita', [Berita::class, 'create'])->name('admin.berita');
    Route::post('/admin/berita', [Berita::class, 'post'])->name('admin.berita.post');
    ...
    Route::post('/layanan/import', [LayananController::class, 'importExcel'])->name('layanan.import');
    Route::post('/layanan/preview', [LayananController::class, 'previewExcel'])->name('layanan.preview');
    Route::get('/layanan/test', [LayananController::class, 'testAjax'])->name('layanan.test');
    ...
    Route::post('/layanan/sort', [LayananController::class, 'updateSortOrder'])->name('layanan.sort');

    //Layanan PPOB
    Route::get('/layanan-ppob', [LayananPpobController::class, 'create'])->name('layanan-ppob');
    Route::post('/layanan-ppob', [LayananPpobController::class, 'store'])->name('layanan-ppob.post');
    Route::post('/layanan-ppob/import', [LayananPpobController::class, 'importExcel'])->name('layanan-ppob.import');
    Route::post('/layanan-ppob/preview', [LayananPpobController::class, 'previewExcel'])->name('layanan-ppob.preview');
    Route::get('/layanan-ppob/hapus/{id}', [LayananPpobController::class, 'delete'])->name('layanan-ppob.delete');
    Route::get('/layanan-ppob-status/{id}/{status}', [LayananPpobController::class, 'update'])->name('layanan-ppob.update');
    Route::get('/layanan-ppob/{id}/detail', [LayananPpobController::class, 'detail'])->name('layanan-ppob.detail');
    Route::post('/layanan-ppob/{id}/detail', [LayananPpobController::class, 'patch'])->name('layanan-ppob.detail.update');
